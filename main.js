...
var routes = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'base',
                loadChildren: function () { return Promise.all(/*! import() | views-base-base-module */[__webpack_require__.e("common"), __webpack_require__.e("views-base-base-module")]).then(__webpack_require__.bind(null, /*! ./views/base/base.module */ "./src/app/views/base/base.module.ts")).then(function (m) { return m.BaseModule; }); }
            },
            {
                path: 'buttons',
            ...
            {
                path: 'notifications',
                loadChildren: function () { return Promise.all(/*! import() | views-notifications-notifications-module */[__webpack_require__.e("default~views-mensajes-mensajes-module~views-notifications-notifications-module"), __webpack_require__.e("views-notifications-notifications-module")]).then(__webpack_require__.bind(null, /*! ./views/notifications/notifications.module */ "./src/app/views/notifications/notifications.module.ts")).then(function (m) { return m.NotificationsModule; }); }
            },
            {
                path: 'mensajes',
                loadChildren: function () { return Promise.all(/*! import() | views-mensajes-mensajes-module */[__webpack_require__.e("default~views-mensajes-mensajes-module~views-notifications-notifications-module"), __webpack_require__.e("common"), __webpack_require__.e("views-mensajes-mensajes-module")]).then(__webpack_require__.bind(null, /*! ./views/mensajes/mensajes.module */ "./src/app/views/mensajes/mensajes.module.ts")).then(function (m) { return m.MensajesModule; }); }
            },
            {
                path: 'theme',
...
module.exports = __webpack_require__(/*! C:\Users\Santiago\Documents\Projects\Citi\ui-angular\ui-angular\ui\src\main.ts */"./src/main.ts");
